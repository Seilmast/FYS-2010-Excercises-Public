...
fig1, ax = plt.subplots(2,2, figsize=(8,8))
...
## Print the value ranges of the original and transformed images.
print(f"\tAlternate Transform")
print(f"r is in range [{img.min()}, {img.max()}]")
print(f"s is in range [{img_6b.min()}, {img_6b.max()}] when gamma = 0.6")
print(f"s is in range [{img_4b.min()}, {img_4b.max()}] when gamma = 0.4")
print(f"s is in range [{img_3b.min()}, {img_3b.max()}] when gamma = 0.3")

## Plot the transformations
fig2, ay = plt.subplots(2,2, figsize=(8,8))
